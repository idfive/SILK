(function($) {
	...
	$.fn.silktabs = function(options) {
		...
		var settings = $.extend({
			prefix: 'silk-tabs',
			wrapperClass: 'silk-tabs--wrapper',
			contentClass: 'silk-tabs--content',
			headerClass: 'silk-tabs--header',
			navClass: 'silk-tabs--nav',
			tabClass: 'silk-tabs--tab',
		...
		var scrollToTabs = function($navUl, $tabsEl)
		{
			...
			if($(locationHash).length)
			{
				...
				var $tabToOpen = $navUl.find('a[href='+locationHash+']');
